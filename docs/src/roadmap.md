...
## Phase 1 — Storage formats *(complete except BSR, which waits for a consumer)*
...
## Phase 2 — Array interface *(in progress: similar/copy/collect, rowvals/findnz, scalar indexing policy, broadcasting shipped)*
